...
public class MealsUtil {
    ...
    public static final List<Meal> mealsForUser2 = Arrays.asList(
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 10, 0), "Завтрак", 500, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 13, 0), "Обед", 1000, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 30, 20, 0), "Ужин", 500, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 0, 0), "Еда на граничное значение", 100, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 10, 0), "Завтрак", 1000, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 13, 0), "Обед", 500, null),
            new Meal(LocalDateTime.of(2022, Month.JANUARY, 31, 23, 0), "Наесться впрок", 9999, null),
            new Meal(LocalDateTime.of(2021, Month.DECEMBER, 31, 0, 0), "Еда на переедание", 2001, null),
            new Meal(LocalDateTime.of(2021, Month.DECEMBER, 30, 11, 30), "Второй завтрак", 1000, null),
